    ...
    <section class="py-40 px-4 bg">
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mt-12 text-center">
                ...
                >
                    <p
                        class="inline-flex items-center gap-2 text-[var(--primary)] font-semibold text-lg hover:underline"
                    >    
...
import features from '@/views/Features/Features.json'

definePageMeta({
  title: 'Fonctionnalité - Silvernote'
})
