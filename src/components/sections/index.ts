// Composants sections - Sections principales de la landing page
...
export { default as UseSnote } from './CallToAction.vue';

// Section components for the landing page (Hero, Features, Testimonials, etc)
