<template>
    ...
    <header class="mt-30 w-screen text-center">
        ...
        <h1 class="uppercase text-9xl font-extrabold">conditions general utilisation</h1>

        <span class="w-screen flex justify-center items-center text-[var(--btn)] font-bold">
